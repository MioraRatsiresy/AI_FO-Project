...
<body>
    <div class="container">
        <form action="<?php echo site_url('Welcome/validerbc'); ?>" method="POST">
            ...
            <div class="card-header p-4">
                <div class="float-right">
                    ...
                    <br />
                    Delai de paiement: <input type="number" placeholder="en jours" name="delai" required>
                </div>
            </div>
            <div class="card-body">
                <div class="row mb-4">
            ...
            <nav>
                <ul class="pager">
                    <?php if ($page > 1 && $page <= count($bcV)) { ?>
                        <li><a href="<?php echo site_url("Welcome/genererBC?page=".($page-1)."&&date=" . $date . "&&value=" . ($value - 1)); ?>">Previous</a></li>
                    <?php }
                    if ($page < count($bcV)) { ?>
                        <li><a href="<?php echo site_url("Welcome/genererBC?page=".($page+1)."&&date=" . $date . "&&value=" . ($value + 1)); ?>">Next</a></li>
                    <?php } ?>
                </ul>
            </nav>
        </form>
