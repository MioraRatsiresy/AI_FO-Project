    ...
    <div class="row">
        <div class="col-md-2" style="margin-left:10px;margin-top:10px;">
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation" id="1" class="active" ><a href="#" onclick="changeActive(1,'listeDemande1')">Demandes</a></li>
                <li role="presentation" id="2" class=""><a href="#" onclick="changeActive(2,'saisieProforma')">Proforma</a></li>
